...
describe('LoginPage', () => {
    ...
    describe("Interactions", () => {
        ...
        it('calls postLogin when the action are provided in props and input fields gave value', () => {
            const actions = {
        ...
        it('it does not thwor expection when clicking the button when actions not provided in', () => {
            setupForSubmit();
        ...
        it("displays spinner when there is on going api call", () => {
            const actions = {
                postLogin: mockAsyncDelayed()
            }
            const {queryByText} = setupForSubmit({actions})
        ...
        it("redirect to HomePage after succesfull login", async() => {
            const actions = {
                postLogin: jest.fn().mockResolvedValue({})
            }
            const history = {
